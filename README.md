# java android travelmadeeasy app
...
TME was created for native Android devices and was developed with Java. This project was part of my project at Metropolia University of Applied Sciences aka Metropolia ammattikorkeakoulu which I did most of the coding part. This app used the Singleton design pattern to hold data and has no backend due to limited time.<br>

The application itself is pretty self-descriptive and I think there's not much guidance needed. Download the app's <a href = "https://github.com/phamduylong/TME/blob/master/app-debug.apk" target = "blank">apk</a> and install the app. You can choose to use the app either as a registered user or a guest, and then you're good to go.<br>
